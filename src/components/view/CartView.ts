...
export class CartView {
  ...
  clear(): void { this.listEl.innerHTML = ""; }
  mountItem(itemEl: HTMLElement): void { this.listEl.appendChild(itemEl); }
  setTotal(total: number): void { this.sumEl.textContent = String(total); }
  setCheckoutDisabled(disabled: boolean): void { this.checkoutBtn.disabled = disabled; }
}